                        ...
                        */
                        ...
                        if (link && net.bennish.tldr.links[link])
                        {
                            ...
                            else
                            {
                                ...
                                console.log("panel created. About to use panel.on(). Here is tldr[link]", net.bennish.tldr.links[link]);

                                // this is necessary as the panel.on('show') function cannot read tldr[link]
                                var trustedLinker = net.bennish.tldr.links[link].trustedLinker;
